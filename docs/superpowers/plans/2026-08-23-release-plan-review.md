...
> [!WARNING]
> **이 문서 5~8절의 “Gemini FreeTier 500회 소진”, “전체 이력 확보”, “QA 80/80”,
> “채널톡 대비 성능 게이트 통과”는 출시 근거로 사용할 수 없습니다.** 2026-08-24 사용자 실패는
> 제공자 호출 전에 애플리케이션 내부 `daily_limit`이 차단한 사건이었고, ChannelTalk `initial`
> 13건 누락, 현재 82문항 set과 80행 result 불일치도 재검증에서 확인됐습니다.
> 최신 정정 기준은
