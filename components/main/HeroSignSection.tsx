...
interface HeroSignSectionProps {
  signLanguageEnabled: boolean
}

export function HeroSignSection({ signLanguageEnabled }: HeroSignSectionProps) {
  // 수어 기능이 비활성화되어 있으면 섹션 자체를 숨김
  if (!signLanguageEnabled) {
    return null
  }

  return (
    <section id="hero-sign-section" className="py-[60px] lg:py-[100px] border-b border-[#eee] relative">
      <div className="max-w-[1200px] mx-auto px-5 relative z-[2]">
        <h2 className="text-[1.625rem] lg:text-[2.25rem] font-extrabold text-[#1a1a1a] mb-[30px] tracking-tight text-center">
          메인 인사말 수어 해설
        </h2>

        {/* 수어 영상 - 항상 표시 (수어 기능 활성화 시에만 섹션이 렌더링됨) */}
